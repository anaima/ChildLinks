...
class PersonnesControllerTest < ActionController::TestCase
  ...
  test "should create personne" do
    assert_difference('Personne.count') do
      post :create, personne: { datedenaissance: @personne.datedenaissance, famille_id: @personne.famille_id, nom: @personne.nom, statut: @personne.statut }
    end
  ...
  test "should update personne" do
    patch :update, id: @personne, personne: { datedenaissance: @personne.datedenaissance, famille_id: @personne.famille_id, nom: @personne.nom, statut: @personne.statut }
    assert_redirected_to personne_path(assigns(:personne))
  end
